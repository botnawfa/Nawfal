...
for (let i = 0; i < img.length; i++) {
  ...
  try {
    ...
    for (const urRRl of datTa) {
      ...
      const tXXxt = `_*< تحميل - انستجرام />*_\n\n▢ *الرابط:* _${shortUrRRl}_`.trim();
      ...
      try {
        ...
        const txt2 = `_*< تحميل - انستجرام />*_\n\n▢ *الرابط:* _${shortUrl2}_`.trim();
        await conn.sendFile(m.chat, resultss, 'error.mp4', txt2, m);
      } catch {
        try {
          const resultssss = await instagramdl(args[0]);
          const shortUrl3 = await (await fetch(`https://tinyurl.com/api-create.php?url=${args[0]}`)).text();
          const txt4 = `_*< تحميل - انستجرام />*_\n\n▢ *الرابط:* _${shortUrl3}_`.trim();
          ...
          try {
            ...
            const txt1 = `_*< تحميل - انستجرام />*_\n\n▢ *الرابط:* _${shortUrl1}_`.trim();
            await conn.sendFile(m.chat, videoig, 'error.mp4', txt1, m);
          } catch {
            throw `_*< تحميل - انستجرام />*_\n\n*[ ℹ️ ] حدث خطأ.  الرجاء معاودة المحاولة في وقت لاحق.*`;
          }
        }
      }
    }
...
handler.command = /^(instagramdl|instagram|igdl|ig|instagramdl2|instagram2|igdl2|ig2|insta|instagram3|igdl3|ig3)$/i;
