...
const handler = async (m, {conn, args, usedPrefix, command}) => {
  ...
  try {
    ...
    if (/webp|image|video/g.test(mime)) {
      ...
      if (!img) throw `*[❗𝐈𝐍𝐅𝐎❗] رجاء قم بالاشارة للصورة التي تريد أن تحولها لملصق و اكتب الامر 
  ${usedPrefix + command}*`;
      let out;
      try {
      ...
      else return m.reply('*[❗𝐈𝐍𝐅𝐎❗] رجاء قم بالاشارة للصورة التي تريد أن تحولها لملصق و اكتب الامر 
 *');
    }
  } catch (e) {
    console.error(e);
    ...
    else throw '*[❗𝐈𝐍𝐅𝐎❗] رجاء قم بالاشارة للصورة التي تريد أن تحولها لملصق و اكتب الامر 
 *';
  }
};
handler.help = ['sfull'];
